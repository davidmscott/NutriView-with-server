    ...
    return (
      <div className="container">
        <div className="row text-left">
          ...
          <div style={{"color": "white", "display": "inline-block", "alignItems": "center", "justifyContent": "center", "marginTop": "2vh"}} className="col-md-12 col-lg-6 text-right hidden-sm-down">
