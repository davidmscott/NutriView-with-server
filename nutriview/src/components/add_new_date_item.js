    ...
    return (
      <div className="container">
        <div className="row text-center">
          <form style={{"display": "inline-block", "marginTop": "2vh"}} className="col-sm-12 col-md-8 col-lg-6 form-inline" onSubmit={event => event.preventDefault()}>
          ...
          <div style={{"color": "white", "display": "inline-block", "alignItems": "center", "justifyContent": "center", "marginTop": "2vh"}} className="col-md-4 col-lg-6 text-right hidden-sm-down">
